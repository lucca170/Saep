...
-- 3. Criação e População da Tabela auth_user (3 registros)
...
-- Inserção de 6 Movimentações (RF3.2)
...
(1, 'E', 10, '2025-11-18', 1), -- Entrada inicial
(2, 'E', 5, '2025-11-18', 1),  -- Entrada inicial
(3, 'E', 5, '2025-11-18', 1),  -- Entrada inicial
(1, 'S', 8, '2025-11-19', 2),  -- Saída (10-8 = 2)
(2, 'S', 5, '2025-11-19', 3),  -- Saída (5-5 = 0)
(3, 'S', 2, '2025-11-19', 2);  -- Saída (5-2 = 3)